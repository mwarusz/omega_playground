...
struct ShallowWaterBase {
  ...
  virtual void compute_h_tendency(Real2d vtend, RealConst2d h, RealConst2d v) const = 0;
  virtual void compute_v_tendency(Real2d htend, RealConst2d h, RealConst2d v) const = 0;
  virtual void additional_tendency(Real2d htend, Real2d vtend, RealConst2d h, RealConst2d v, Real t) const {}
  ...
  void compute_tendency(Real2d htend, Real2d vtend, RealConst2d h, RealConst2d v, Real t) const {
...
struct ShallowWater : ShallowWaterBase {
  Real2d hflux;
  void compute_h_tendency(Real2d vtend, RealConst2d h, RealConst2d v) const override;
  void compute_v_tendency(Real2d htend, RealConst2d h, RealConst2d v) const override;
