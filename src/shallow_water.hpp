...
struct ShallowWaterBase {
  ...
  virtual void compute_h_tendency(Real2d vtend, RealConst2d h, RealConst2d v,
                                  AddMode add_mode) const = 0;
  virtual void compute_v_tendency(Real2d htend, RealConst2d h, RealConst2d v,
                                  AddMode add_mode) const = 0;
...
struct ShallowWater : ShallowWaterBase {
  Real2d hflux;
  void compute_h_tendency(Real2d vtend, RealConst2d h, RealConst2d v,
                          AddMode add_mode) const override;
  void compute_v_tendency(Real2d htend, RealConst2d h, RealConst2d v,
                          AddMode add_mode) const override;
